...
url = "https://www.chmi.cz/files/portal/docs/meteo/opss/pocasicko_nove/st_11520_cz.html" #praha-libus
...
result = chmi_scraper(url)


result.to_csv("chmu_tab_libus.csv", index=False)
